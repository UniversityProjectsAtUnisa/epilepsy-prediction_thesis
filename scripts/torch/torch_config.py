...
PATIENT_GENERIC_OUTPUT_DIRNAME = get_envvar("PATIENT_GENERIC_OUTPUT_DIRNAME", "patientgeneric")
...
PATIENT_GENERIC_OUTPUT_DIRPATH = OUTPUT_DIRPATH/PATIENT_GENERIC_OUTPUT_DIRNAME
SAVED_MODEL_DIRPATH = OUTPUT_DIRPATH/SAVED_MODEL_DIRNAME
