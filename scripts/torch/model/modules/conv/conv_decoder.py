...
class ConvDecoder(nn.Module):
    def __init__(self, sample_length, sample_freqs, n_channels):
        ...
        self.conv1 = nn.ConvTranspose3d(4, 4, (1, 3, 3), stride=(1, 1, 2), padding=(0, 0, 1), output_padding=(0, 0, 1))
        self.bn1 = nn.BatchNorm3d(4)

        self.conv2 = nn.ConvTranspose3d(4, 2, (1, 3, 3), stride=(1, 1, 3))
        self.bn2 = nn.BatchNorm3d(2)

        self.conv3 = nn.ConvTranspose3d(2, 1, (n_channels, 3, 7), stride=(1, 2, 7), padding=(0, 0, 6))
