...
def plot_range_loss(losses_normal,losses_seizures=None, MODEL_NAME='model',THRESHOLD: float=None): # type: ignore
    plt.figure(dpi=300)
    plt.style.use('dark_background')
    sns.histplot(losses_normal, bins=30, kde=True, stat="density", linewidth=0) # type: ignore
    ...
    if losses_seizures!=None:
        ...
        sns.histplot(losses_seizures, bins=30, kde=True,color="r", stat="density", linewidth=0) # type: ignore
